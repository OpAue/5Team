    ...
    fundings: [
      {
        id: 1,
        category: '맛집',
        title: '오늘 저녁 홍대 돈까스 번개',
        locationName: '홍대입구 돈까스 거리',
        ...
        description:
          '수업 끝나고 홍대입구 근처 돈까스집에 같이 갈 사람을 찾습니다. 장소와 시간은 확정되어 있고, 1명만 더 오면 바로 출발할 수 있어요.',
      ...
      },
      {
        ...
        description:
          '서로 다른 캠퍼스 생활 이야기를 나누는 가벼운 커피챗입니다. 처음 참여하는 사람도 부담 없도록 자기소개와 관심사 토크로 시작해요.',
      ...
      },
      {
        ...
        description:
          '오늘 밤 풋살 인원을 구합니다. 세부 장소와 팀 구성은 참여자가 모이면 다시 정할 예정입니다.',
